...
if __name__ == '__main__':
    ...
    an_array = cuda.device_array(testdata_dev.shape[:-1], dtype=float)  # create on GPU directly, no need for copying

    get_slope_cuda[blockspergrid, threadsperblock, stream](x_dev, testdata_dev, Sx, Sx2, SxSx, an_array)
